...
function Show-DesktopNextSteps {
    ...
    Write-Info "Apply the change, then stay in PowerShell and run:"
    Write-Host ""
    Write-Host "    .\scripts\lon.ps1 -UseRepo doctor"
    Write-Host ""
...
function Show-EngineNextSteps {
    ...
    Write-Info "After WSL is ready, stay in PowerShell and run:"
    Write-Host ""
    Write-Host "    .\scripts\lon.ps1 -UseRepo --dry-run doctor --fix"
    Write-Host "    .\scripts\lon.ps1 -UseRepo doctor --fix"
    Write-Host "    .\scripts\lon.ps1 -UseRepo doctor"
    Write-Host ""
